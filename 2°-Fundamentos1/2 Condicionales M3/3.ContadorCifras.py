...
if n<=9:
    print('Su numero tiene 1 cifra')
elif n<=99:
    print('Su numero tiene 2 cifras')
elif n<=999:
    print('Su numero tiene 3 cifras')
elif n<=9999:
    print('Su numero tiene 4 cifras')
else:
    print('Su numero tiene mas de 4 cifras, exede los limites.')
